...
Feature: Order
  ...
  Scenario Outline: Order some products as User
    ...
    @Chrome_1400x1000
    Examples:
      | firstName | lastName | email          | password  | productUrl                               | productSize | productStyle | company             | address     | city           | state    | zip   | country       | cardNumber       | month | year |
      | Jakobi    | Doe      | jakobi@doe.com | topsecret | productDetail/Grizzly%20Bear?productId=1 | 32 x 24 in  | gloss        | Monster Corporation | 621 Wall St | North Tonawada | New York | 14120 | United States | 4111111111111111 | 05    | 2030 |

    @Firefox
    @Firefox_1400x1000
    Examples:
      | firstName | lastName | email          | password  | productUrl                               | productSize | productStyle | company             | address     | city           | state    | zip   | country       | cardNumber       | month | year |
      | Justus    | Doe      | justus@doe.com | topsecret | productDetail/Grizzly%20Bear?productId=1 | 32 x 24 in  | gloss        | Monster Corporation | 621 Wall St | North Tonawada | New York | 14120 | United States | 4111111111111111 | 05    | 2030 |
